...
simply copy-paste [this URL](https://github.com/kuzudb/kuzu/releases/download/v0.8.3/kuzu_cli-linux-x86_64.tar.gz)
for x86-64 or [this one](https://github.com/kuzudb/kuzu/releases/download/v0.8.3/kuzu_cli-linux-aarch64.tar.gz)
for aarch64 into your browser.

**x86-64**

```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.8.3/kuzu_cli-linux-x86_64.tar.gz
```

**aarch64**

```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.8.3/kuzu_cli-linux-aarch64.tar.gz
```
...
Use a tool like cURL to download the latest version of the Kuzu CLI to your local machine. Alternatively,
simply copy-paste [this HTTPS URL](https://github.com/kuzudb/kuzu/releases/download/v0.8.3/kuzu_cli-windows-x86_64.zip)
into your browser.

```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.8.3/kuzu_cli-windows-x86_64.zip
```
...
```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.8.3/libkuzu-osx-universal.tar.gz
```
...
```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.8.3/libkuzu-linux-x86_64.tar.gz
```

**aarch64**

```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.8.3/libkuzu-linux-aarch64.tar.gz
```
...
```bash
curl -L -O https://github.com/kuzudb/kuzu/releases/download/v0.8.3/libkuzu-windows-x86_64.zip
```
